...
@Configuration
// wskazuje, ze klasa zawiera konfiguracje bean’ów Spring
@EnableTransactionManagement
// umozlwia konfigurowanie mechanizmów transakcji z wykorzystaniem adnotacji
@EnableJpaRepositories(basePackages = { "edu.iis.mto.integrationtest.repository" })
// okresla gdzie szukac klas definiujacych repozytoria Spring Data.
